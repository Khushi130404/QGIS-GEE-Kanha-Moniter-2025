...
ndvi_folder = r"D:\QGIS_GEE_Kanha_Moniter_2025\GEE_GeoPackage\GEE_NDVI_2025_Gap_Fill"
roi_shp = r"D:\QGIS_GEE_Kanha_Moniter_2025\ROI\Grassland_2\kanha_grass_2.shp"

# --------------------------------------------------
# CREATE MEMORY TABLE
# --------------------------------------------------

table = QgsVectorLayer("None", "Kanha_Gap_Grass_TimeSeries_ROI_2", "memory")
